...
async function fetchStockData() {
    try {
        ...
        let errorOutput = `<p style="color:red;color:red;font-weight:bold">Failed to fetch stock data: ${error}</p>`
...
async function fetchNewsData(filterType) {
    try {
        ...
        let errorOutput = `<p style="color:red;color:red;font-weight:bold">Failed to fetch news articles: ${error}</p>`
